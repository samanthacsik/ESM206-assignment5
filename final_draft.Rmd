...
<<<<<<< HEAD
  ...
  We lastly use multiple linear regression to describe faculty salary based on X, Y, Z. We later suggest additional parameters that we believe may help to better inform our model.
...
*Shifts in female PhD recipients by field (1985, 2000, 2015)*
  ...
  Despite this diversification among women graduate students, underrepresentation of women in STEM fields across the entire U.S. graduate student populace (males and females) remains an obvious disparity. We found that the proportion of female PhD recipients is significantly different than male PhD recipients across each of our four focal fields (_X_^2^ Education (`r edu_x2$parameter`) = `r edu_x2$statistic`, _p_ < 0.001, _X_^2^ Enineering (`r eng_x2$parameter`) = `r eng_x2$statistic`, _p_ < 0.001, _X_^2^ Humanities & Arts (`r arts_x2$parameter`) = `r arts_x2$statistic`, _p_ < 0.001, _X_^2^ Physical & Earth Sciences (`r physsci_x2$parameter`) = `r physsci_x2$statistic`, _p_ < 0.001), and that men largely outnumber women in both STEM fields (Engineering, Physical & Earth Sciences) (Table 2).
