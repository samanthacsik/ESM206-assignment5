...
**Discussion and Caveats:**
  While our report demonstrates that female involvement in higher education has improved, there are still steps to be made for progress after obtaining degrees. The data show that the proportion of female doctoral recipients has increased, but only 29% of faculty are women (cite NCES, https://nces.ed.gov/programs/digest/d17/tables/dt17_315.60.asp). Additionally, female faculty are penalized for having partners or children, while male faculty remain unaffected or even benefit from marriage and children (cite chronicle, https://www.chronicle.com/article/The-Baby-Penalty/140813). Women who navigate the world of academia are well aware of gender disparities in the workplace (see Merritt Turetsky's essay "Women and relationships in academia: a curious journey of self-reflection") but the reality is that, while awareness of the issue is a logical first step, this is an institutional problem that is larger than any one individual can take on. The much needed revolution for gender equality in academia will come from active recruitment of candidates with a track record of allyship and advocacy for gender equality. As Audre Lorde states of the misappropriation of Black women as "tokens" in academia, "the master's tools will never dismantle the master's house. They may allow us temporarily to beat him at his own game, but they will never enable us to bring about genuine change" (cite Lorde). Just as we cannot continue to pay lip service to Black scholars to satisfy some "diversity" requirement, we cannot continue to hire faculty who are uncommitted to enacting change in the academic community.  
  While the data we have are as much as we can gather, there are missing components that would be useful for parameterizing a model describing faculty salaries. Institution type (e.g. research institutions vs liberal arts colleges, public vs private universities) determines professorial 
