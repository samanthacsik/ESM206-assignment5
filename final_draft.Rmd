...
**Introduction: ** 
  In the last few decades, more women have pursued higher education than ever before. Over 40 years from 1966 to 2016, the percent of female high school graduates enrolled in college or university has grown from almost 30%, from 42.7% to 71.9% (cite table, https://nces.ed.gov/programs/digest/d17/tables/dt17_302.10.asp?current=yes). Female bachelor's degree recipients have grown from 43.1% to 57.3% in the same time span (cite table, https://nces.ed.gov/programs/digest/d17/tables/dt17_318.10.asp?current=yes). 
