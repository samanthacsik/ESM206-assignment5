...
# Figure 3: Median annual salary (USD) for doctorate recipients with definite postgraduations plans in the U.S., by sex (2015).
...
fac_plot <- ggplot(data = faculty_salary, aes(x = years_service, y = salary)) +
