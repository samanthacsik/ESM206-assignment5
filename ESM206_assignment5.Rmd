...
female_phd_perc <- female_phd %>% 
  mutate(perc_1985  = (`1985`/tot_1985) * 100, perc_2000 = (`2000`/tot_2000) * 100, perc_2015 = (`2015`/tot_2015) * 100) %>% 
...
female_phd_plot <- ggplot(female_phd_long, aes(x = year, y = percent, fill = field_long)) + 
