...
female_phd <- fields %>% 
  filter(field == "phys_earth_female" | 
           field == "math_female" | field == "psy_soc_female" | 
           field == "engineering_female" | field == "edu_female" | 
           field == "humanities_arts_female" | field == "other_female") %>% 
...
female_phd_long <- melt(female_phd, variable.name = "year", value.name = "raw")

##############################
# create stacked barplot
##############################

female_phd_plot <- ggplot(female_phd_long, aes(x = year, y = raw, fill = field)) + 
...
####To Do:
1) make figure legend show up
2) stats (mainly initial exploratory shit that I can't get to work)
